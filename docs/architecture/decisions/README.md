...
| [0029](0029-in-kind-gifts-are-a-gift-type-whose-value-never-enters-the-money-rollups.md) | An in-kind gift is a gift type carrying no amount, and its value is rolled up separately from money | Accepted |
...
be built without. ADR-0029 is a builder decision for G-18, and it answers the
question ADR-0022 recorded as open about a gift recorded at zero.

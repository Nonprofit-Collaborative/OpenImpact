...
| [0029](0029-which-health-check-findings-get-a-fix-button.md) | Which Health Check findings get a fix button | Accepted |
...
be built without.
ADR-0029 is a builder decision for C-21, stating the six conditions a Health Check finding has
to meet before it is given a fix button, and recording that no fix action may delete a record.

...
| [0025](0025-donor-levels-read-a-rollup-and-follow-the-total-down.md) | A donor level labels an existing rollup, and follows that total down | Accepted |
...
collision ADR-0022 recorded as still open, between R-SC5 and R-SC6 in G-08. ADR-0025 is a builder
decision for G-14, answering the four questions donor levels cannot be built without.

...
| [0031](0031-gift-batch-entry-does-not-stage-through-the-import-framework.md) | Gift batch entry keeps its own rows rather than staging through the import framework | Accepted |
...
be built without. ADR-0031 is a builder decision for G-17, recording why gift batch
entry does not stage its rows through the import framework the plan pointed at.

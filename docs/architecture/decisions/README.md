...
| [0029](0029-acknowledgments-are-standard-email-plus-a-ledger.md) | Acknowledgments send standard email templates and keep a ledger, sharing no machinery with receipts | Accepted |
...
be built without. ADR-0029 is a builder decision for G-12, separating acknowledgments from

...
The ADR-NEXT placeholders at the end of the table are product owner decisions on the record
pages (plan Section 4). The integrator assigns their numbers at merge.

...
| [NEXT](NEXT-data-management-scope.md) | Data management runs in the org, compiles queries from a document, and is phased | Accepted |
...
ADR-NEXT is a product owner decision on the scope and phasing of data management: import,

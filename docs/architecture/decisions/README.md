...
| [NEXT](NEXT-duplicates-use-the-orgs-own-duplicate-rules.md) | Duplicate detection uses the org's own duplicate rules, and Open Impact ships none | Accepted (builder decision) |

...
Added by acknowledgments (G-12, ADR-0029).
...
ADR-0029). A rule matches a gift on the things a fundraising office actually sorts gifts
...
One thank you, recorded (feature G-12, ADR-0029). The row exists so that the questions
...
One send (ADR-0029). It exists for the same reason the receipt run does, and for one more:
